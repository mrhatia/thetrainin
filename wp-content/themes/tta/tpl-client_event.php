<?php
/**
 * Template Name: Client Event Page 
 *
...
<?php $full_service_banner_choose_layout= get_field( 'client_eventdefault_choose_layout', 'option'  ); 
if( $full_service_banner_choose_layout=='fullbannerdefault') { ?>
<section class="sectionCl new_banner_section">
    <div class="container">

			<?php $eventdefault_banner_image = get_field( 'client_eventdefault_banner_image', 'option'  ); ?>
        ...
        <div class="new_banner_label">
            <div class="top-label"><?php the_field( 'client_eventdefault_blog_title', 'option' ); ?></div>
        </div>

        <div class="new_banner_content ">
            
            <div class="main-title"><h1><?php the_field( 'client_eventdefault_sub_title' , 'option' ); ?></h1></div>

          <?php the_field( 'eventdefault_content' , 'option' ); ?>
		  
		  <?php $eventdefault_button = get_field( 'client_eventdefault_button' , 'option' ); ?>
        ...
        <div class="container">
          <div class="banner-detail">
               <div class="banner-detail__flex">
                   <div class="top-label">
                     <?php the_field( 'client_eventdefault_blog_title' , 'option' ); ?>            
                   </div>
                   <div class="main-title">
                      <h1><?php the_field( 'client_eventdefault_sub_title' , 'option' ); ?></h1>
                   </div>
                   <?php the_field( 'client_eventdefault_content' , 'option' ); ?>
        ...
        <div class="container">
          <div class="banner-detail">
		   ...
		   <div class="banner-btn">
			...
			<?php $eventdefault_button_two = get_field( 'client_eventdefault_button_two' , 'option' ); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-6">
					<div class="banner-detail">
						<div class="top-label">
							<?php the_field( 'client_eventdefault_heading', 'option' ); ?>
						</div>
						<div class="main-title">
							<h1><?php the_field( 'client_eventdefault_title', 'option' ); ?></h1>
						</div>
						<img src="<?php echo get_template_directory_uri(); ?>/images/pattern-bottom.png" alt="pattern-bottom" class="img-fluid">
					</div>
				</div>
				<?php $eventdefault_image = get_field( 'client_eventdefault_image', 'option' ); ?>
...
<?php if ( have_rows( 'flexible_layout_client_event_page' ) ): ?>
	<?php while ( have_rows( 'flexible_layout_client_event_page' ) ) : the_row(); ?>
<?php if ( get_row_layout() == 'telnt_center_content_block' ) : ?>	
<section class="strategy-simple">
			<div class="container">
				<div class="text-block">
					<div class="section-title">
						<span><?php the_sub_field( 'client_event_detail_title_secon' ); ?></span>
						<h2><?php the_sub_field( 'client_event_detail_sub_title_secon' ); ?></h2>
					</div>
					<?php the_sub_field( 'client_event_detail_content_secon' ); ?>
					<?php $centre_simple_link = get_sub_field( 'client_event_detail_button_link_secon' ); ?>
...
<?php elseif ( get_row_layout() == 'client_event_right_image_content_block' ) : ?>
<?php  $client_event_content_layout= get_sub_field( 'client_event_content_layout' ); 
	if($client_event_content_layout=='leftimage'){ ?>
<section class="image-pattern">
			<div class="container">
					<div class="row align-items-center">
					<div class="col-sm-12 col-md-6">
						<?php $image_right_content_image = get_sub_field( 'client_event_right_image' ); ?>
						...
						<div class="col-sm-12 col-md-6">
							<div class="text-block text-start" style=" margin-left: 106px;">
								<div class="section-title text-start ">
									<span><?php the_sub_field( 'client_event_right_heading' ); ?></span>
									<h2><?php the_sub_field( 'client_event_right_title' ); ?></h2>
								</div>
								<?php the_sub_field( 'client_event_right_content' ); ?>
							<?php $image_right_content_button = get_sub_field( 'client_event_right_button' ); ?>
	...
	<?php }elseif($client_event_content_layout=='rightimage'){ ?>
<section class="image-pattern" >
	<div class="container">
		<div class="row align-items-center">					
			<div class="col-sm-12 col-md-6">
...
jQuery( document ).ready(function() {
    flt_clinet_event('html'); 
});
function flt_clinet_event(htmltype){
	
	 jQuery( "#aj_status" ).val('prosessing');
	 ajpage++;
	 jQuery( ".podcast_ajax_loader" ).show();
	 jQuery(".client_event_load_more_remove_mo").fadeIn(400).html('<div class="resource_loader"><img src="<?php echo get_template_directory_uri().'/images/loader.gif'; ?>" align="absmiddle" alt="Loading..." ></div>');
	 
	jQuery.ajax({
		url:'<?php echo site_url(); ?>/wp-admin/admin-ajax.php',
		type: "post",
		data: {
			action: 'client_event_fun',
			setpage: ajpage,
			 
			 
		},
		success: function(data){
		 jQuery(".client_event_load_more_remove_mo").remove();
			if(htmltype=='append'){
...
<?php if ( have_rows( 'client_eventdefault_callout_button', 'option' ) ) : ?>
	<?php while ( have_rows( 'client_eventdefault_callout_button', 'option' ) ) : the_row(); ?>
<section class="signup">
	<div class="container">
		<div class="section-title">
			<span><?php the_sub_field( 'client_eventdefault_title_btn' ); ?></span>
			<h2><?php the_sub_field( 'client_eventdefault_subtitle_btn' ); ?></h2>
		</div>
		<?php //the_sub_field( 'casestudy_call_out_short_code' ); ?>
		<div class="sign-form">
			<?php $casestudy_call_out_short_code = get_sub_field( 'client_eventdefault_callout_button' ); ?>
