...
<section class="event_footer-section">
     <div class="container">
            <div class="reserve_icon_section-main">
                <div class="row">
					<?php if(get_field( 'client_evetn_speaker_name' )){ ?> 
                    <div class="col-xs-12 col-sm-6 col-lg-3">
                        <div class="reserve_icon_section">
						<?php $evetn_speaker_name_icon = get_field( 'client_evetn_speaker_name_icon' ); ?>
							...
							<?php } ?>
                            <h4><?php the_field( 'client_evetn_speaker_name' ); ?></h4>
                        </div>
                    </div>
					<?php } ?>
					<?php if(get_field( 'client_event_date' )){ ?> 
                    <div class="col-xs-12 col-sm-6 col-lg-3">
                        <div class="reserve_icon_section">
						<?php $event_date_icon = get_field( 'client_event_date_icon' ); ?>
						...
						<?php }else{ ?>
                            ...
                            <h4><?php the_field( 'client_event_date' ); ?></h4>
                        </div>
                    </div>
					<?php } ?>
					<?php if(get_field( 'client_event_time' )){ ?> 
                    <div class="col-xs-12 col-sm-6 col-lg-3">
                        <div class="reserve_icon_section">
						<?php $event_time_icon = get_field( 'client_event_time_icon' ); ?>
                            ...
                            <h4><?php the_field( 'client_event_time' ); ?></h4>
                        </div>
                    </div>
					<?php } ?>
					<?php if(get_field( 'client_event_price' )){ ?> 
                    <div class="col-xs-12 col-sm-6 col-lg-3">
                        <div class="reserve_icon_section">
						<?php $event_price_icon = get_field( 'client_event_price_icon' ); ?>
                            ...
                            <h4><?php the_field( 'client_event_price' ); ?></h4>
                        </div>
                    </div>
					<?php } ?>
...
<section class="event_footer-section">
     <div class="container">
			...
			<?php $event_zoom_link = get_field( 'client_event_zoom_link' ); 
			 $event_zoom_link_two = get_field( 'client_event_zoom_link_two' ); 
			  $event_zoom_link_three = get_field( 'client_event_zoom_link_three' ); 
			   $event_zoom_link_four = get_field( 'client_event_zoom_link_four' ); ?>
			...
			<?php if ( have_rows( 'client_event_speaker_block' ) ) : ?>
			<?php while ( have_rows( 'client_event_speaker_block' ) ) : the_row(); ?>
            <div class="speaker-section">
				 <?php if(get_sub_field( 'client_evn_speaker_name' )){ ?>
                <h2>Speaker: <?php the_sub_field( 'client_evn_speaker_name' ); ?></h2>
				 <?php } ?>
                <div class="row align-items-center">
				<?php $evn_speaker_image = get_sub_field( 'client_evn_speaker_image' ); ?>
				<?php if ( $evn_speaker_image ) { ?>
                    ...
                    <div class="col-xs-12 col-sm-7">
                        <p><?php the_sub_field( 'client_evn_speaker_short_content' ); ?></p>
                    </div>
                </div>
            </div>
			<?php endwhile; ?>
