...
?>
<?php if($design_variation === 'slider'){ ?>

    <section class="staff-section slider-variation-outer">
        <div class="profile-card-outer">
            <div class="container">
                ...
                <div class="profile-card-wrapper-inner slider-variation" id="ttaExpertsGrid">
                    <div class="profile-card-inner-slider">
                ...
                <?php else : ?>
                <div class="bottom-link-text">
                    Explore More Talent & Roles on TTA Connect
                </div>
                <?php endif; ?>
                <?php if ($button) : ?>
